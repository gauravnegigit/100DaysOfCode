...
def send_email(current_time):
    ...
    msg['From'] = 'gnstcs1729@gmail.com'
      
    # storing the receivers email address 
    msg['To'] = "gauravnegi1729220@gmail.com"
    ...
    # Authentication
    s.login("gnstcs1729@gmail.com", "EV2178518G")
      
    # Converts the Multipart msg into a string
    text = msg.as_string()
      
    # sending the mail
    s.sendmail("gnstcs1729@gmail.com", "gauravnegi1729220@gmail.com", text)
